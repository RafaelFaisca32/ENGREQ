...
import com.mycompany.myapp.service.InspectionQueryService;
...
public class InspectionResource {
    ...
    public ResponseEntity<InspectionDTO> createInspection(@Valid @RequestBody InspectionDTO inspectionDTO) throws URISyntaxException {
        ...
        if (inspectionDTO.getHiveId() != 0 && inspectionDTO.getHiveId() != null) {
            HiveDTO hiveDTO = new HiveDTO();
            hiveDTO.setId(inspectionDTO.getHiveId());
            inspectionDTO.setHive(hiveDTO);
        }
    ...
    public ResponseEntity<InspectionDTO> partialUpdateInspection(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody InspectionDTO inspectionDTO
    ) throws URISyntaxException {
