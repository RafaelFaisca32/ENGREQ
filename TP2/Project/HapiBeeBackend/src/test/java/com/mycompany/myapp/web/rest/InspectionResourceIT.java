...
class InspectionResourceIT {
    ...
    public static Inspection createEntity(EntityManager em) {
        Inspection inspection = new Inspection().date(DEFAULT_DATE).note(DEFAULT_NOTE);
        return inspection;
    }
    ...
    public static Inspection createUpdatedEntity(EntityManager em) {
        Inspection inspection = new Inspection().date(UPDATED_DATE).note(UPDATED_NOTE);
        return inspection;
    }
    ...
    void putExistingInspection() throws Exception {
        ...
        updatedInspection.date(UPDATED_DATE).note(UPDATED_NOTE);
    ...
    void partialUpdateInspectionWithPatch() throws Exception {
        ...
        partialUpdatedInspection.date(UPDATED_DATE);
    ...
    void fullUpdateInspectionWithPatch() throws Exception {
        ...
        partialUpdatedInspection.date(UPDATED_DATE).note(UPDATED_NOTE);
