...
class AnnualInventoryDeclarationResourceIT {
    ...
    private static final AnnualInventoyDeclarationState DEFAULT_ANNUAL_INVENTORY_DECLARATION_STATE =
        AnnualInventoyDeclarationState.APPROVED;
    private static final AnnualInventoyDeclarationState UPDATED_ANNUAL_INVENTORY_DECLARATION_STATE =
        AnnualInventoyDeclarationState.DECLINED;
