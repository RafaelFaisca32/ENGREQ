...
import { of } from 'rxjs';
import { ApiaryDetailPage } from './apiary-detail';

describe('ApiaryDetailPage', () => {
  let component: ApiaryDetailPage;
  let fixture: ComponentFixture<ApiaryDetailPage>;
  const entityMock = {
    id: 0,
    user: {},
  };
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ApiaryDetailPage);
