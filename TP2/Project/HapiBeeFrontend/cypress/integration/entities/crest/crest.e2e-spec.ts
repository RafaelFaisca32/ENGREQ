...
describe('Crest entity', () => {
  ...
  describe('navigation test with items', () => {
    ...
    it('should open Crest view, open Crest edit and go back', () => {
      ...
      if (crest.combFrameQuantity !== undefined && crest.combFrameQuantity !== null) {
        crestDetailPage.getCombFrameQuantityContent().contains(crest.combFrameQuantity);
      }
  ...
  describe('creation test', () => {
    ...
    it('should create Crest', () => {
      ...
      crestUpdatePage.getPageTitle().should('have.text', SUBCOMPONENT_TITLE);
      if (crestSample.combFrameQuantity !== undefined && crestSample.combFrameQuantity !== null) {
        crestUpdatePage.setCombFrameQuantityInput(crestSample.combFrameQuantity);
      }
