...
describe('Inspection entity', () => {
  ...
  describe('creation test', () => {
    ...
    it('should create Inspection', () => {
      ...
      if (inspectionSample.type !== undefined && inspectionSample.type !== null) {
        inspectionUpdatePage.setTypeInput(inspectionSample.type);
      }
      if (inspectionSample.state !== undefined && inspectionSample.state !== null) {
        inspectionUpdatePage.setStateInput(inspectionSample.state);
      }
      inspectionUpdatePage.save();
