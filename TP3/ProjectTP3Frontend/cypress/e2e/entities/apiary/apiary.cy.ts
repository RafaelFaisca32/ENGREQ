...
describe('Apiary entity', () => {
  ...
  describe('navigation test with items', () => {
    ...
    it('should open Apiary view, open Apiary edit and go back', () => {
      ...
      if (apiary.coordX !== undefined && apiary.coordX !== null) {
        apiaryDetailPage.getCoordXContent().contains(apiary.coordX);
      }
      if (apiary.coordY !== undefined && apiary.coordY !== null) {
        apiaryDetailPage.getCoordYContent().contains(apiary.coordY);
      }
      if (apiary.coordZ !== undefined && apiary.coordZ !== null) {
        apiaryDetailPage.getCoordZContent().contains(apiary.coordZ);
      }
  ...
  describe('creation test', () => {
    ...
    it('should create Apiary', () => {
      ...
      if (apiarySample.coordX !== undefined && apiarySample.coordX !== null) {
        apiaryUpdatePage.setCoordXInput(apiarySample.coordX);
      }
      if (apiarySample.coordY !== undefined && apiarySample.coordY !== null) {
        apiaryUpdatePage.setCoordYInput(apiarySample.coordY);
      }
      if (apiarySample.coordZ !== undefined && apiarySample.coordZ !== null) {
        apiaryUpdatePage.setCoordZInput(apiarySample.coordZ);
      }
