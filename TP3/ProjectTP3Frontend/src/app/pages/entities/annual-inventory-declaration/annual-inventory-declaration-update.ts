...
import { AnnualInventoryDeclaration, AnnualInventoryDeclarationState } from './annual-inventory-declaration.model';
        ...
        this.apiaryService.query(reqApiary).subscribe(
          dataApiary => {
            ...
            for (const a of this.apiaries) {
              ...
              apiaryInformations.push(new ApiaryInformation(a.id,a.apiaryZoneId,a.name,10,a.intensive,a.transhumance,'x','y','z',10,'?',null));
            }
            ...
            this.annualInventoryDeclaration = new AnnualInventoryDeclaration(null,total,this.beekeeper.faxNumber,
              ...
              // eslint-disable-next-line max-len
              this.beekeeper.phoneNumber,this.beekeeper.entityZoneResidence.toString(),this.beekeeper.beekeeperNumber,AnnualInventoryDeclarationState.PENDING,
