...
public class BeekeeperCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering BeekeeperState
     */
    public static class BeekeeperStateFilter extends Filter<BeekeeperState> {

        public BeekeeperStateFilter() {}

        public BeekeeperStateFilter(BeekeeperStateFilter filter) {
            super(filter);
        }

        @Override
        public BeekeeperStateFilter copy() {
            return new BeekeeperStateFilter(this);
        }
    }
    ...
    private BeekeeperStateFilter state;
    ...
    public BeekeeperStateFilter getState() {
        return state;
    }

    public BeekeeperStateFilter state() {
        if (state == null) {
            state = new BeekeeperStateFilter();
        }
        return state;
    }

    public void setState(BeekeeperStateFilter state) {
        this.state = state;
    }
