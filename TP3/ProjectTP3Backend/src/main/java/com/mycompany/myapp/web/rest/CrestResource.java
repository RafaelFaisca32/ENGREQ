...
public class CrestResource {
    ...
    public CrestResource(CrestService crestService, CrestRepository crestRepository, CrestQueryService crestQueryService, UserService userService, HiveService hiveService) {
    ...
    public ResponseEntity<CrestDTO> createCrest(@Valid @RequestBody CrestDTO crestDTO) throws URISyntaxException {
        ...
        hiveService.removeFramesFromHive(result.getHive(), result.getFrames());
