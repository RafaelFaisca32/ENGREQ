...
public class Beekeeper implements Serializable {
    ...
    public BeekeeperState getState() {
        return this.state;
    }

    public Beekeeper state(BeekeeperState state) {
        this.setState(state);
        return this;
    }

    public void setState(BeekeeperState state) {
        this.state = state;
    }
    ...
    public void setTranshumanceRequests(Set<TranshumanceRequest> transhumanceRequests) {
        if (this.transhumanceRequests != null) {
            this.transhumanceRequests.forEach(i -> i.setBeekeeper(null));
        }
        if (transhumanceRequests != null) {
            transhumanceRequests.forEach(i -> i.setBeekeeper(this));
        }
        this.transhumanceRequests = transhumanceRequests;
    }

    public Beekeeper transhumanceRequests(Set<TranshumanceRequest> transhumanceRequests) {
        this.setTranshumanceRequests(transhumanceRequests);
        return this;
    }

    public Beekeeper addTranshumanceRequest(TranshumanceRequest transhumanceRequest) {
        this.transhumanceRequests.add(transhumanceRequest);
        transhumanceRequest.setBeekeeper(this);
        return this;
    }

    public Beekeeper removeTranshumanceRequest(TranshumanceRequest transhumanceRequest) {
        this.transhumanceRequests.remove(transhumanceRequest);
        transhumanceRequest.setBeekeeper(null);
        return this;
    }
