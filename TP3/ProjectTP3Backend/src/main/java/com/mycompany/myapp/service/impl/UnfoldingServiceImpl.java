...
public class UnfoldingServiceImpl implements UnfoldingService {
    ...
    public Page<UnfoldingDTO> findAllWithEagerRelationships(Pageable pageable) {
        return unfoldingRepository.findAllWithEagerRelationships(pageable).map(unfoldingMapper::toDto);
    }
    ...
    public Optional<UnfoldingDTO> findOne(Long id) {
        ...
        return unfoldingRepository.findOneWithEagerRelationships(id).map(unfoldingMapper::toDto);
    }
