...
public class AnnualInventoryDeclarationCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering AnnualInventoryDeclarationState
     */
    public static class AnnualInventoryDeclarationStateFilter extends Filter<AnnualInventoryDeclarationState> {

        public AnnualInventoryDeclarationStateFilter() {}

        public AnnualInventoryDeclarationStateFilter(AnnualInventoryDeclarationStateFilter filter) {
            super(filter);
        }

        @Override
        public AnnualInventoryDeclarationStateFilter copy() {
            return new AnnualInventoryDeclarationStateFilter(this);
        }
    }
    ...
    private AnnualInventoryDeclarationStateFilter annualInventoryDeclarationState;
    ...
    public AnnualInventoryDeclarationStateFilter getAnnualInventoryDeclarationState() {
        return annualInventoryDeclarationState;
    }

    public AnnualInventoryDeclarationStateFilter annualInventoryDeclarationState() {
        if (annualInventoryDeclarationState == null) {
            annualInventoryDeclarationState = new AnnualInventoryDeclarationStateFilter();
        }
        return annualInventoryDeclarationState;
    }

    public void setAnnualInventoryDeclarationState(AnnualInventoryDeclarationStateFilter annualInventoryDeclarationState) {
