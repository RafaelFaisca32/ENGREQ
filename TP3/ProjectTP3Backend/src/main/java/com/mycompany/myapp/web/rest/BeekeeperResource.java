...
public class BeekeeperResource {
    ...
    public ResponseEntity<BeekeeperDTO> createBeekeeper(@Valid @RequestBody BeekeeperDTO beekeeperDTO) throws URISyntaxException {
    ...
    public ResponseEntity<BeekeeperDTO> updateBeekeeper(
        ...
        @Valid @RequestBody BeekeeperDTO beekeeperDTO
    ...
    public ResponseEntity<BeekeeperDTO> partialUpdateBeekeeper(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody BeekeeperDTO beekeeperDTO
    ) throws URISyntaxException {
