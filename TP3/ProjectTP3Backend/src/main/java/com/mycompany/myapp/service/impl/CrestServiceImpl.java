...
public class CrestServiceImpl implements CrestService {
    ...
    public Page<CrestDTO> findAllWithEagerRelationships(Pageable pageable) {
        return crestRepository.findAllWithEagerRelationships(pageable).map(crestMapper::toDto);
    }
    ...
    public Optional<CrestDTO> findOne(Long id) {
        ...
        return crestRepository.findOneWithEagerRelationships(id).map(crestMapper::toDto);
    }
